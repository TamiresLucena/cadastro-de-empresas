...
class Database {
  ...
  void insertCompany() {
    ...
    print(
        'Enter the registration Number of the company to be add (ONLY NUMBERS):');
    ...
    if (partnerType == "L") {
      ...
      partner = NaturalPerson(
          partnerName, registrationNumber, addressPartner, partnerType);
    }
  ...
  dynamic printCompany(Company company) {
    ...
    Address of company: 
      ...
      ${company.address.city}/${company.address.stateFormatted()}, 
      ${company.address.showZipCode()}
    Partner:
      ...
      Address of partner: 
        ${company.partner.address.street}, 
        ${company.partner.address.number},
        ${company.partner.address.complement}, 
        ${company.partner.address.district}, 
        ${company.partner.address.city}/${company.partner.address.stateFormatted()}, 
        ${company.partner.address.showZipCode()} 
    ===================================================''');
  }
